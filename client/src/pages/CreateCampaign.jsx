...
const Input = ({ placeholder,name, type, minimumContribution, handleChangeCampaign }) => (
  <input
...
const CreateCampaign = () => {
  const { isLoadingNewCampaign, handleChangeCampaign, formCampaign, createNewCampaign } = useContext(CampaignFactoryContext);
  ...
  return (
    <div>
      ...
      {isLoadingNewCampaign ? (
        <Loader />
      ): (<button type="button" onClick={handleSubmitCampaign} 
